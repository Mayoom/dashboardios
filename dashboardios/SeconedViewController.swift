...
//               let  LineChartConfig = ChartConfigXY(xAxisConfig: ChartAxisConfig(from: 0, to: 24, by: 1), yAxisConfig: ChartAxisConfig(from: 0, to: 1600, by: 200))
//
//        let lchart = LineChart(frame: frame, chartConfig: LineChartConfig, xTitle: "Hour", yTitle:  "VP", lines:[(ChartPoint:[
//            (1,50.0),
//            (2,100.0),
//            (3,250.0),
//            (4,300.0),
